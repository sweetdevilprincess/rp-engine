<footer class="h-11 bg-surface border-t border-border-custom flex items-center justify-between px-4 shrink-0">
	...
	<a
		...
		class="w-[30px] h-[30px] rounded-md border border-border-custom bg-bg flex items-center justify-center
			text-text-dim hover:text-text hover:border-border-warm transition-colors"
		title="GitHub"
	>
		<svg class="w-[15px] h-[15px]" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
